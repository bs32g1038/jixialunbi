...
export const getEmailTemplate = ({ greeting, description }: getEmailTemplateProps) => {
  const communityLogo = 'http://www.jixialunbi.com/_next/static/media/logo.6c8e1874.png';
